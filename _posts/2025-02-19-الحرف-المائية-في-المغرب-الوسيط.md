...
<div class="prose prose-lg mx-auto">
    ...
    <p class="text-lg text-stone-700 leading-relaxed mb-5">
    يجب أخذ عدة عوامل بعين الاعتبار، منها قوة المنافسة الأجنبية وتسارع وتيرة العمل بفعل استخدام الآلات المتطورة (المكننة)، فضلاً عن تأثير الظروف الجوية في تأخير العمل وإطالة مدة الدبغ. ويُضاف إلى ذلك تحفظ أغلب الحرفيين عن الإدلاء بمعطيات دقيقة في ما يتعلق بهذا الموضوع.
    </p>
    ...
    <div class="not-prose bg-white rounded-xl shadow-sm p-8 my-10 border border-stone-200">
      ...
      <p class="text-stone-700 mb-6">
        رغم هذه العوائق، حاولنا مقاربة الجانب المادي من خلال رصد أبرز التحولات التي تعرفها حرفة الدباغة. واعتماداً على الزيارة الميدانية والروايات الشفوية التي استقيناها من الحرفيين، قدمنا تصوراً تقريبياً للدخل الفردي لكل معلم انطلاقاً من عدد الطرحات المصنوعة، وتتبع مسار الطرحة من مرحلة الشراء (ثمن شرائها) إلى مرحلة البيع (ثمن بيعها)، مروراً بالمدة التي تستغرقها الصناعة، وكذلك المواد المستعملة في الدباغة وكلفتها.
      </p>
