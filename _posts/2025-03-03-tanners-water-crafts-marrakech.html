...
date: 2025-03-03
description: " دراسة تفصيلية لحرفة الدباغة في مدينة مراكش وعلاقتها بالماء، مع
  تتبع تاريخي لتطورها وتقنياتها وتأثيرها على البنية العمرانية للمدينة، وتحليل
  لاستمراريتها في النسيج الاقتصادي والاجتماعي المعاصر ومواجهتها للتحديات البيئية
  والاقتصادية الحديثة"
categories:
  - الحرف-التقليدية
  - التاريخ-الحضري
...
<div class="prose prose-lg mx-auto">
    ...
    <div class="not-prose bg-amber-50 rounded-lg p-6 border-r-4 border-amber-500 mb-8">
      ...
      <div class="mt-4 text-stone-600 text-sm">
        ...
        <div>"كلية الآداب والعلوم الإنسانية، جامعة القاضي عياض"</div>
        <div>مادة: الحرف المائية</div>
  ...
  <ul class="space-y-3 list-none pr-0 mb-6">
    ...
    <li class="pb-2 border-b border-stone-100">
      <span class="font-bold">ابن حزم الأندلسي، أبو محمد علي بن أحمد.</span> "المحلى بالآثار"، دار الفكر، بيروت، د.ت.
    </li>
    <li class="pb-2 border-b border-stone-100">
    ...
    <li>
      <span class="font-bold">الجزنائي، علي بن أبي زرع.</span> "الأنيس المطرب بروض القرطاس في أخبار ملوك المغرب وتاريخ مدينة فاس"، المطبعة الملكية، الرباط، 1972.
    </li>
  </ul>
