...
<div class="prose prose-lg mx-auto">
    ...
    <div class="flex items-center justify-center mb-8">
      <div class="text-center max-w-2xl">
        <p class="text-gray-600 mb-4">ماستر: الماء في تاريخ المغرب</p>
        <p class="text-gray-600 mb-4">"كلية الاداب والعلوم الإنسانية، جامعة القاضي عياض"</p>
        <p class="text-gray-600 mb-4">مادة: الحرف المائية</p>
      ...
      <div class="md:col-span-2">
        <div id="primary-sources">
          ...
          <ul class="space-y-3 text-stone-700 list-none">
            ...
            <li class="pb-2 border-b border-stone-100">الأندلسي، أبو محمد علي ابن أحمد حزم: "المحلى بالآثار"، كتاب الطهارة، تحقيق: عبدالغفار سليمان النياري، ج1، منشورات دار الكتب العلمية، بيروت، لبنان، ط3، 1424هـ/2003م.</li>
            ...
            <li class="pb-2 border-b border-stone-100">الكتاني أبي عبدالله محمد بن جعفر بن ادريس: "سلوة الأنفاس ومحادثة الأكياس بمن أقبر من العلماء الصلحاء بفاس"، الموسوعة الكتانية لتاريخ فاس، ج1، تحقيق: الشريف محمد بن علي الكتاني.</li>
        ...
        <div id="studies" class="mt-10">
          ...
          <ul class="space-y-3 text-stone-700 list-none">
            ...
            <li class="pb-2 border-b border-stone-100">أزايكو علي صدقي: "نماذج من أسماء الأعلام الجغرافية والبشرية المغربية"، منشورات المعهد الملكي للثقافة الأمازيغية.</li>
            ...
            <li class="pb-2 border-b border-stone-100">حسن علي حسن: "الحضارة الإسلامية في المغرب والأندلس عصر المرابطين والموحدين"، كلية دار العلوم جامعة القاهرة، ط1، منشورات الخنانجي، مصر.</li>
    ...
    <div class="not-prose bg-amber-50 rounded-lg p-6 border-r-4 border-amber-500 mb-8">
      <div class="flex items-start">
        ...
        <div>
          ...
          <p class="mt-1 text-stone-700">
            ماستر: الماء في تاريخ المغرب<br>
            "كلية الاداب والعلوم الإنسانية، جامعة القاضي عياض"<br>
            مادة: الحرف المائية<br>
