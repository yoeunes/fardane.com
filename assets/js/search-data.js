...
ninja.data = [{
    ...
    handler: () => {
      ...
      description: "دراسة تحليلية نقدية لأهمية الموارد المائية وعلاقتها بتشييد المدن وتطور العمران والحرف من خلال مصدر جغرافي وسيط",
      section: "Posts",
      handler: () => {
        
          window.location.href = "/blog/2025/dbgha/";
