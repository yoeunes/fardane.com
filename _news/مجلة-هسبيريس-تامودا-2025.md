...
<div class="not-prose mt-8 p-6 bg-amber-50 rounded-xl border border-amber-200">
    ...
    <div class="flex flex-wrap gap-3">
        <a href="https://doi.org/10.5281/zenodo.18059506" target="_blank" class="inline-flex items-center px-5 py-3 bg-amber-600 text-white rounded-lg hover:bg-amber-700 transition-colors font-medium">
    ...
    <p class="text-stone-500 text-sm mt-3">DOI: 10.5281/zenodo.18059506</p>
</div>
...
<div class="not-prose bg-stone-50 rounded-2xl p-6 border border-stone-200" dir="rtl">
    ...
    <!-- SECTION 1: Moroccan Studies (amber) -->
    <div class="mb-6">
        ...
        <ul class="space-y-2 text-sm text-stone-700">
            ...
            <li class="flex items-start gap-2">
                <i class="fas fa-circle text-amber-600 mt-1.5 text-xs flex-shrink-0"></i>
                <span>Laroui, Abdallah. <em>The History of the Maghrib: An Interpretive Essay</em>. Princeton: Princeton University Press, 1977.</span>
            </li>
        </ul>
    </div>

    <!-- SECTION 2: About Hespéris-Tamuda (stone) -->
    <div>
        ...
        <ul class="space-y-2 text-sm text-stone-700">
            <li class="flex items-start gap-2">
                ...
                <span>كلية الآداب والعلوم الإنسانية - الرباط. <em>هسبيريس-تامودا: دليل المؤلفين والمساهمين</em>. الرباط: جامعة محمد الخامس، 2024.</span>
            </li>
            <li class="flex items-start gap-2">
                <i class="fas fa-circle text-stone-500 mt-1.5 text-xs flex-shrink-0"></i>
                <span>Rivet, Daniel. "Hespéris-Tamuda: Un siècle d'historiographie marocaine." <em>Hespéris-Tamuda</em> 50 (2015): 9–25.</span>
            </li>
        </ul>
    </div>
</div>
