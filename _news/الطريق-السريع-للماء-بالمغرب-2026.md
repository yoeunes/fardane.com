...
<p class="text-stone-700 leading-relaxed mb-4">
    يتلقى <strong>شمال غرب المغرب</strong> — الذي تهيمن عليه سلسلة الريف وسفوح الأطلس المتوسط — تساقطاتٍ وافرة نسبياً تتراوح بين 500 و1800 ملم/سنة حسب المناطق. وتستنزف أحواض اللكوس وسبو وأبي رقراق مسطحاتٍ واسعة بمتوسطات جريان ذات شأن. ويُعدّ حوض سبو — وفق بيانات وكالة الحوض المائي لسبو — بمساحته التي تقارب 40000 كم² ومعدل جريانه الذي يناهز 5.7 مليار م³/سنة، الحوضَ الأوفر حظاً على الإطلاق في الموارد المائية القابلة للتعبئة.
</p>
...
<p class="text-stone-700 leading-relaxed mb-4">
    يُخطِّط مشروع ربط الأحواض المائية المُدرَج — وفق البرنامج الوطني للماء — في المخطط الوطني للماء 2020-2050 لإنشاء شبكة من القنوات والأنفاق ومحطات الضخ والناقلات، تُتيح إعادة توزيع مئات الملايين من الأمتار المكعبة سنوياً من الأحواض الشمالية نحو المناطق العاجزة.
</p>
...
<div class="not-prose bg-stone-50 rounded-2xl p-6 border border-stone-200" dir="rtl">
    ...
    <div class="mb-6">
        ...
        <ul class="space-y-2 text-sm text-stone-700">
            ...
            <li class="flex items-start gap-2">
                <i class="fas fa-circle text-amber-600 mt-1.5 text-xs flex-shrink-0"></i>
                <span>Molle, François, and Peter Mollinga. "Water Poverty Indicators: Conceptual Problems and Policy Issues." <em>Water Policy</em> 5, no. 5-6 (2003): 529–544.</span>
            </li>
            <li class="flex items-start gap-2">
                <i class="fas fa-circle text-amber-600 mt-1.5 text-xs flex-shrink-0"></i>
                <span>الركيك، هشام. <em>السياسة المائية بالمغرب: من سياسة السدود إلى التدبير المندمج</em>. الدار البيضاء: منشورات أفريقيا الشرق، 2019.</span>
            </li>
        </ul>
    </div>
    ...
    <div>
        ...
        <ul class="space-y-2 text-sm text-stone-700">
            <li class="flex items-start gap-2">
                ...
                <span>وزارة التجهيز والماء. <em>البرنامج الوطني للتزويد بالماء الشروب 2020-2027</em>. الرباط، 2020.</span>
            </li>
            <li class="flex items-start gap-2">
                <i class="fas fa-circle text-stone-500 mt-1.5 text-xs flex-shrink-0"></i>
                <span>المكتب الوطني للكهرباء والماء الصالح للشرب (ONEE). <em>مشروع الربط بين الأحواض المائية</em>. الرباط، 2023.</span>
            </li>
            <li class="flex items-start gap-2">
                <i class="fas fa-circle text-stone-500 mt-1.5 text-xs flex-shrink-0"></i>
                <span>World Bank. <em>Morocco: Managing Water Scarcity and Climate Change</em>. Washington, DC: World Bank, 2020.</span>
            </li>
        </ul>
    </div>
</div>
