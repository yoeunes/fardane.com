...
date: 2026-02-01
description: "شكّل الجفاف الذي ضرب المغرب بين عامي 2019 و2025 الحلقة الأشد وطأةً في تاريخه الحديث. تحليل لهذه الأزمة في ضوء التاريخ الهيدروليكي للمغرب وانهيار النصيب الفردي من الماء: من 2560 م³ في الستينيات إلى 565 م³ عام 2025."
...
<div class="not-prose bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-8 mb-8 border border-amber-200" dir="rtl">
    ...
    <p class="text-base text-amber-800 text-center font-medium mb-4">سبع سنوات من الجفاف — انفراج مطري بارز في يناير 2026</p>
    <p class="text-base text-stone-600 text-center leading-relaxed">
        في يناير 2026، وبعد سبع سنوات من جفاف تاريخي أنهك معدلات امتلاء السدود، وأفرغ الفرشات الباطنية، وزعزع التوازنات الغذائية للبلاد، أسهمت أمطار خريف وشتاء 2025-2026 في إحداث انفراج مائي ملموس. وقفة تحليلية عند أزمة أجبرت المملكة المغربية على إعادة التفكير الجذري في سياستها المائية.
    </p>
</div>
...
<h3 class="text-2xl font-bold text-amber-900 mb-6 border-b-2 border-amber-200 pb-3">خامساً: انفراج 2025-2026 والدروس المستخلَصة</h3>

<p class="text-stone-700 leading-relaxed mb-4">
    أحدث خريف 2025 تحولاً ملموساً في المشهد. إذ هطلت أمطار سخية بفعل منخفضات أطلسية متتالية منذ شهر نوفمبر على الشمال والوسط المغربي. وفي يناير 2026، تجاوز معدل امتلاء السدود 45%، مُعلِناً انفراجاً مائياً واضحاً بعد سنوات القحط. وسجّلت بعض الأحواض، كحوضي سبو وأبي رقراق، روافد قريبة من معدلاتها التاريخية.
</p>

<p class="text-stone-700 leading-relaxed mb-4">
    لا ينبغي لهذا الانفراج المطري أن يُوهِم. فالخبراء متوافقون على أن الهشاشة المائية الهيكلية للمغرب لا تتبدد بأولى الأمطار الغزيرة. فالإجهاد المائي للمغرب واقع جيوفيزيائي وديمغرافي طويل الأمد يتعين على الاستثمارات الجارية استيعابه دون أدنى تراخٍ في المجهود.
</p>
...
<div class="not-prose bg-stone-50 rounded-xl p-6 mb-8 border border-stone-200" dir="rtl">
    ...
    <ul class="space-y-3 text-stone-700">
        ...
        <li class="flex items-start gap-3">
            ...
            <span><strong>التضامن الترابي</strong>: سلّطت التفاوتات الجهوية أمام الجفاف الضوءَ على ضرورة بناء تضامن مائي وطني أعمق، وهو بالضبط ما يستهدفه المشروع الكبير للتحويل بين الأحواض شمالاً-جنوباً.</span>
        </li>
    </ul>
</div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
        <div class="bg-white border border-stone-200 rounded-xl p-5 shadow-sm">
            ...
            <ul class="space-y-2 text-xs text-stone-700">
                <li>• ابن خلدون، <em>المقدمة</em>، دار الفكر، بيروت 2001 (تحليل أثر الجفاف في أفول الحضارات المغربية)</li>
                <li>• الناصري (أحمد بن خالد)، <em>الاستقصا لأخبار دول المغرب الأقصى</em>، دار الكتاب، الدار البيضاء 1954 (أخبار الجفافات والمجاعات)</li>
                <li>• ابن أبي زرع، <em>روض القرطاس</em>، الرباط 1973 (سنوات القحط في التاريخ المغربي الوسيط)</li>
            </ul>
        </div>
        <div class="bg-white border border-stone-200 rounded-xl p-5 shadow-sm">
            <h4 class="font-bold text-stone-800 mb-3 text-sm border-b border-stone-200 pb-2">
            ...
            <ul class="space-y-2 text-xs text-stone-700">
                <li>• وزارة التجهيز والماء (المغرب)، <em>تقرير الحالة المائية السنوية</em>، الرباط 2019–2025</li>
                <li>• المجلس الأعلى للماء والمناخ، <em>تقرير الأمن المائي للمغرب في أفق 2050</em>، الرباط 2021</li>
                <li>• بنعلي، عبد الرحيم، <em>شُح الماء في المغرب: جذور الأزمة وآفاق الحل</em>، مجلة الاقتصاد والمال، الرباط 2023</li>
                <li>• الصخيري، ليلى، <em>المناخ التاريخي وتاريخية الجفاف في المغرب</em>، رسالة دكتوراه، جامعة محمد الخامس، الرباط 2020</li>
            </ul>
        </div>
        <div class="bg-white border border-stone-200 rounded-xl p-5 shadow-sm">
            <h4 class="font-bold text-stone-800 mb-3 text-sm border-b border-stone-200 pb-2">
            ...
            <ul class="space-y-2 text-xs text-stone-700">
                <li>• Tramblay, Y. et al. (2020). "Future evolution of extreme precipitation in Morocco". <em>Atmosphere</em>, 11(5), 516.</li>
                <li>• Schilling, J. et al. (2012). "Climate change vulnerability, water resources and social implications in North and West Africa". <em>Regional Environmental Change</em>, 12(3), 695–713.</li>
                <li>• Bouchaou, L. et al. (2009). "Application of multiple isotopic and geochemical tracers for the characterization of shallow groundwater in northwest Morocco". <em>Journal of Hydrology</em>, 378, 40–52.</li>
                <li>• Sebbar, A. et al. (2011). "Variability of rainfall indices in Morocco during the 20th century". <em>Sécheresse</em>, 22(3), 139–148.</li>
            </ul>
        </div>
    </div>
</div>
...
<div class="not-prose bg-stone-50 rounded-2xl p-6 border border-stone-200" dir="rtl">
    ...
    <div class="mb-6">
        ...
        <ul class="space-y-2 text-sm text-stone-700">
            ...
            <li class="flex items-start gap-2">
                <i class="fas fa-circle text-amber-600 mt-1.5 text-xs flex-shrink-0"></i>
                <span>العروي، عبد الله. <em>مجمل تاريخ المغرب</em>. الدار البيضاء: المركز الثقافي العربي، 2009.</span>
            </li>
        </ul>
    </div>
    ...
    <div>
        ...
        <ul class="space-y-2 text-sm text-stone-700">
            <li class="flex items-start gap-2">
                ...
                <span>وزارة التجهيز والماء. <em>تقرير حول وضعية الموارد المائية بالمغرب 2019-2025</em>. الرباط، 2025.</span>
            </li>
            <li class="flex items-start gap-2">
                <i class="fas fa-circle text-stone-500 mt-1.5 text-xs flex-shrink-0"></i>
                <span>IPCC. <em>Climate Change 2021: Impacts, Adaptation and Vulnerability – Africa</em>. Cambridge: Cambridge University Press, 2022.</span>
            </li>
            <li class="flex items-start gap-2">
                <i class="fas fa-circle text-stone-500 mt-1.5 text-xs flex-shrink-0"></i>
                <span>World Bank. <em>Morocco Climate Change and Water: Country Assessment</em>. Washington, DC: World Bank, 2021.</span>
            </li>
        </ul>
    </div>
</div>
