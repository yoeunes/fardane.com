...
<div class="not-prose bg-stone-50 rounded-2xl p-6 border border-stone-200" dir="rtl">
    ...
    <!-- SECTION 1: Research Cooperation Studies (amber) -->
    <div class="mb-6">
        <h5 class="font-bold text-amber-800 mb-3 flex items-center gap-2 text-sm border-b border-amber-200 pb-2">
            ...
            أولاً: دراسات حول التعاون العلمي الأفريقي
        </h5>
        <ul class="space-y-2 text-sm text-stone-700">
            <li class="flex items-start gap-2">
                <i class="fas fa-circle text-amber-600 mt-1.5 text-xs flex-shrink-0"></i>
                <span>Zeleza, Paul Tiyambe. "The African Academic Diaspora and African Universities." In <em>The Development of Higher Education in Africa</em>. London: Routledge, 2020.</span>
            </li>
            <li class="flex items-start gap-2">
                <i class="fas fa-circle text-amber-600 mt-1.5 text-xs flex-shrink-0"></i>
                <span>الخطيب، محمد. <em>التعاون العلمي بين الجامعات الأفريقية: الواقع والآفاق</em>. الرباط: منشورات CNRST، 2022.</span>
            </li>
        </ul>
    </div>
    ...
    <div>
        ...
        <ul class="space-y-2 text-sm text-stone-700">
            <li class="flex items-start gap-2">
                ...
                <span>المركز الوطني للبحث العلمي والتقني (CNRST). <em>دليل برنامج فينكوم للتعاون الأفريقي</em>. الرباط، 2026.</span>
            </li>
            <li class="flex items-start gap-2">
                <i class="fas fa-circle text-stone-500 mt-1.5 text-xs flex-shrink-0"></i>
                <span>African Union. <em>Science, Technology and Innovation Strategy for Africa 2024</em>. Addis Ababa: African Union Commission, 2024.</span>
            </li>
        </ul>
    </div>
</div>
