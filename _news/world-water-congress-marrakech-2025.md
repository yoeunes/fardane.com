    ...
    <div class="bg-white rounded-xl p-6 border border-stone-200 shadow-sm">
        <div class="flex items-start gap-4">
            ...
            <div>
                ...
                <p class="text-stone-700 text-sm leading-relaxed">الحق في الماء (حق الماء)، والتفاوتات الإقليمية في الوصول إلى الموارد، والسياسات التنظيمية وآليات التضامن بين الأحواض. وقد قُدّم نموذج المغرب بتحويله الشمالي-الجنوبي البالغ 484 مليون م³/سنة باعتباره نموذجاً في إعادة التوازن الترابي.</p>
            </div>
        </div>
    </div>
